PRO master_create_apply_glt_batch
  ...
  ;fl_list = [fileDir + 'FL03',fileDir + 'FL05',fileDir + 'FL08',fileDir + 'FL10',fileDir + 'FL11'] ;Only do these flighlines in this directory

  ;Loop through flightline folders (FL01, FL02, FL03,....)
  foreach element,fl_list do begin
    print, 'Starting with ' + element
    fpath = element + '\' ;Set filepath and change directory
    cd, fpath
